...
private["_dialog", "_lockerAmount", "_lockerLimit", "_depositInput", "_withdrawInput", "_lockerAmountLabel", "_inventoryAmount", "_inventoryAmountString", "_inventoryAmountLabel", "_prefixAmountDsplay", "_prefixLimitDisplay", "_prefixAmountDisplay", "_lockerAmountDsplay", "_lockerLimitDisplay", "_inventoryAmountDisplay"];
